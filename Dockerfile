...
RUN curl https://getcomposer.org/download/1.10.25/composer.phar > composer-1.phar
RUN curl https://getcomposer.org/download/2.2.6/composer.phar > composer-2.phar
RUN chmod +x *.phar
