...
if [ -n "$action_packagist_username" ]
then
	echo "Storing packagist auth info"
	composer config -g -a http-basic.repo.packagist.com "$action_packagist_username" "$action_packagist_token"
fi
